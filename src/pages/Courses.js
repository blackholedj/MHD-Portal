    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105">
      <div className="p-5">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500 mb-1">{course.description}</p>
          </div>
          {isAdmin && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="border-t md:border-t-0 md:border-r border-gray-200">
          <h4 className="font-semibold p-3 bg-gray-200 text-center text-sm text-gray-600">
            Ranní část
          </h4>
          <img
            ...
            onClick={() => setSelectedImage(getPhotoUrl(course.morning_photo_path))}
          />
        </div>
        <div>
          <h4 className="font-semibold p-3 bg-gray-100 text-center text-sm text-gray-600 border-t border-gray-200">
            Odpolední část
          </h4>
          <img
            ...
            className="w-full h-48 object-cover"
            onClick={() =>
              setSelectedImage(getPhotoUrl(course.afternoon_photo_path))
            }
          />
        </div>
      </div>
      ...
      {selectedImage && (
        <div
          ...
          onClick={() => setSelectedImage(null)} // zavření kliknutím mimo obrázek
        >
          <img
            src={selectedImage}
            alt="Náhled"
